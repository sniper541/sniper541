server {
    ...
    root /var/www/sniper541.ru/html;
    index owner.html;
    charset utf-8;

    # WebDAV (Windows-friendly)
    location = /webdav {
    return 301 /webdav/;
    }	
    ...
    alias /var/www/sniper541.ru/html/sites/map/data.json;
    ...
    # Статические файлы для /book, /game, /resume
    location ~ ^/sites/(book|game|resume)/.*\.(css|js|png|jpg|jpeg|gif|ico|woff|woff2|ttf|svg|eot)$ {
        root /var/www/sniper541.ru/html;
        try_files $uri =404;
    }

    # Перенаправление /book, /game, /resume на /sites/...
    location /book {
        alias /var/www/sniper541.ru/html/sites/book;
        index index.html;
    }

    location /game {
        alias /var/www/sniper541.ru/html/sites/game;
        index index.html;
    }

    location /resume {
        alias /var/www/sniper541.ru/html/sites/resume;
        index index.html;
    }
	
	location /map {
        alias /var/www/sniper541.ru/html/sites/map;
        index index.html;
    }
